...
namespace EveComFramework.Move
{
    ...
    public class Move : EveComFramework.Core.State
    {
        ...
        bool BookmarkWarp(object[] Params)
        {
            ...
            if (Entity.All.Any(a => (a.GroupID == Group.LargeCollidableObject || a.GroupID == Group.LargeCollidableShip || a.GroupID == Group.LargeCollidableStructure || a.CategoryID == Category.Asteroid) && a.Type != "Beacon" && a.Distance <= (double)(Config.WarpCollisionTrigger * 1000))
                    && Collision == null)
            {
                Collision = Entity.All.FirstOrDefault(a => (a.GroupID == Group.LargeCollidableObject || a.GroupID == Group.LargeCollidableShip || a.GroupID == Group.LargeCollidableStructure || a.CategoryID == Category.Asteroid) && a.Type != "Beacon" && a.Distance <= (double)(Config.WarpCollisionTrigger * 1000));
                    ...
                    && Collision != Entity.All.FirstOrDefault(a => (a.GroupID == Group.LargeCollidableObject || a.GroupID == Group.LargeCollidableShip || a.GroupID == Group.LargeCollidableStructure || a.CategoryID == Category.Asteroid) && a.Type != "Beacon" && a.Distance <= (double)(Config.WarpCollisionTrigger * 500)))
            {
                ...
                Log.Log("|oOrbiting");
                Log.Log(" |-g{0}(|w{1} km|-g)", Collision.Name, Config.WarpCollisionOrbit);
                Collision.Orbit((int)(Config.WarpCollisionTrigger * 500));
                InsertState(BookmarkWarp, -1, Destination, Distance, Collision);
            }
            else if (Entity.All.FirstOrDefault(a => (a.GroupID == Group.LargeCollidableObject || a.GroupID == Group.LargeCollidableShip || a.GroupID == Group.LargeCollidableStructure || a.CategoryID == Category.Asteroid) && a.Type != "Beacon" && a.Distance <= (double)(Config.WarpCollisionTrigger * 1000)) == null)
            {
        ...
        bool ApproachState(object[] Params)
        {
            ...
            if (Target.Distance > Distance)
            {
                ...
                else if (Entity.All.FirstOrDefault(a => (a.GroupID == Group.LargeCollidableObject || a.GroupID == Group.LargeCollidableShip || a.GroupID == Group.LargeCollidableStructure) && a.Type != "Beacon" && a.Distance <= (double)(Config.ApproachCollisionTrigger * 1000)) != null
                        && Collision == null
                        && Config.ApproachCollisionPrevention)
                {
                    Collision = Entity.All.FirstOrDefault(a => (a.GroupID == Group.LargeCollidableObject || a.GroupID == Group.LargeCollidableShip || a.GroupID == Group.LargeCollidableStructure) && a.Type != "Beacon" && a.Distance <= (double)(Config.ApproachCollisionTrigger * 1000));
                    Log.Log("|oOrbiting");
                ...
                else if (Entity.All.Where(a => (a.GroupID == Group.LargeCollidableObject || a.GroupID == Group.LargeCollidableShip || a.GroupID == Group.LargeCollidableStructure) && a.Type != "Beacon" && a.Distance <= (double)(Config.ApproachCollisionTrigger * 1000)).FirstOrDefault() == null
                        && Collision != null
                        && Config.ApproachCollisionPrevention)
                {
                    Log.Log("|oApproaching");
        ...
        bool OrbitState(object[] Params)
        {
            ...
            // Else, if we're in trigger of a structure and aren't already orbiting a structure, orbit it and set it as our collision target
            else if (Entity.All.Any(a => (a.GroupID == Group.LargeCollidableObject || a.GroupID == Group.LargeCollidableShip || a.GroupID == Group.LargeCollidableStructure || a.CategoryID == Category.Asteroid) && a.Type != "Beacon" && a.Distance <= (double)(Config.OrbitCollisionTrigger * 1000))
                    && Collision == null
                    && Config.OrbitCollisionPrevention)
            {
                Collision = Entity.All.FirstOrDefault(a => (a.GroupID == Group.LargeCollidableObject || a.GroupID == Group.LargeCollidableShip || a.GroupID == Group.LargeCollidableStructure || a.CategoryID == Category.Asteroid) && a.Type != "Beacon" && a.Distance <= (double)(Config.OrbitCollisionTrigger * 1000));
                Log.Log("|oOrbiting");
            ...
            else if (!Entity.All.Any(a => (a.GroupID == Group.LargeCollidableObject || a.GroupID == Group.LargeCollidableShip || a.GroupID == Group.LargeCollidableStructure || a.CategoryID == Category.Asteroid) && a.Type != "Beacon" && a.Distance <= 8000)
                    && Collision != null
                    && Config.OrbitCollisionPrevention)
            {
                Log.Log("|oOrbiting");
        ...
        bool Dock(object[] Params)
        {
            ...
            if (Entity.All.FirstOrDefault(a => (a.GroupID == Group.LargeCollidableObject || a.GroupID == Group.LargeCollidableShip || a.GroupID == Group.LargeCollidableStructure) && a.Type != "Beacon" && a.Distance <= (double)(Config.WarpCollisionTrigger * 1000)) != null
                    && Collision == null)
            {
                Collision = Entity.All.FirstOrDefault(a => (a.GroupID == Group.LargeCollidableObject || a.GroupID == Group.LargeCollidableShip || a.GroupID == Group.LargeCollidableStructure) && a.Type != "Beacon" && a.Distance <= (double)(Config.WarpCollisionTrigger * 1000));
                Log.Log("|oToo close for warp, orbiting");
                Log.Log(" |-g{0}(|w{1} km|-g)", Collision.Name, Config.WarpCollisionOrbit);
                Collision.Orbit((int)(Config.WarpCollisionOrbit * 1000));
            ...
            else if (Entity.All.FirstOrDefault(a => (a.GroupID == Group.LargeCollidableObject || a.GroupID == Group.LargeCollidableShip || a.GroupID == Group.LargeCollidableStructure) && a.Type != "Beacon" && a.Distance <= (double)(Config.WarpCollisionTrigger * 1000)) == null)
            {
                Log.Log("|oDocking");
                Log.Log(" |-g{0}", Target.Name);
                Target.Dock();
